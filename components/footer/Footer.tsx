...
export const Footer = () => {
  return (
    <>
      <footer className="bg-gray-950 border-t border-gray-900 py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4 pt-6">
              The premier platform for digital art and NFT collections.
              Discover, collect, and sell extraordinary artwork.
            </p>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>© 2025 NeonArt Gallery. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
